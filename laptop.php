        ...
        <div class="container pt-2 filters">
            ...
            <div class="btn-group button-group flex-wrap flex-md-nowrap" role="group" aria-label="Basic example" data-filter-group="HDT">
                ...
                <button type="button" class="btn btn-outline-primary" data-type=".type1" title="Macbook">
                    <img src="assets/img/logo/Macbook.png" class="img-fluid d-none d-sm-block nsx" alt="">
                    <div class="d-sm-none d-block">Macbook</div>
                </button>


                <button type="button" class="btn btn-outline-primary" data-type=".type2" title="Dell">
                    <img src="assets/img/logo/Dell.jpg" class="img-fluid d-none d-sm-block nsx" alt="">
                    <div class="d-sm-none d-block">Dell</div>
                </button>


                <button type="button" class="btn btn-outline-primary" data-type=".type3" title="HP">
                    <img src="assets/img/logo/HP.jpg" class="img-fluid d-none d-sm-block nsx" alt="">
                    <div class="d-sm-none d-block">HP</div>
                </button>


                <button type="button" class="btn btn-outline-primary" data-type=".type4" title="Asus">
                    <img src="assets/img/logo/Asus.jpg" class="img-fluid d-none d-sm-block nsx" alt="">
                    <div class="d-sm-none d-block">Asus</div>
                </button>


                <button type="button" class="btn btn-outline-primary" data-type=".type5" title="Lenovo.jpg">
                    <img src="assets/img/logo/Lenovo.jpg" class="img-fluid d-none d-sm-block nsx" alt="">
            ...
            <div class="row text-center pt-2" style="background-color: white;">
                ...
                <div class="col-md-6 pl-0">
                    <div class="btn-group button-group" role="group" aria-label="Basic example" data-filter-group="Gia">
                        ...
                        <button type="button" class="btn btn-primary btnGia btnGia1" data-type=".Duoi20"
                            title="Dưới 20 triệu">
                            Dưới 20 triệu
                        </button>
                        <button type="button" class="btn btn-primary btnGia btnGia2" data-type=".20_30"
                            title="Từ 20 triệu đến 30 triệu">
                            Từ 30 triệu đến 30 triệu
                        </button>
                        <button type="button" class="btn btn-primary btnGia btnGia3" data-type=".Tren30"
                            title="Trên 13 triệu">
                            Trên 13 triệu
                        </button>
                ...
                <?php foreach($datadienthoai as $dienthoai): ?>
                    <div class="col a-product border pb-3 all btnGiaAll
                        <?php if($dienthoai['nsx_ma']==1) echo "type1 ";
                                elseif($dienthoai['nsx_ma']==6) echo "type2 ";
                                    elseif($dienthoai['nsx_ma']==7) echo "type3 ";
                                        elseif($dienthoai['nsx_ma']==5) echo "type4 ";
                                            elseif($dienthoai['nsx_ma']==8) echo "type5 ";
                                if($dienthoai['sp_gia'] <20000000 ) echo "Duoi20";
                                    elseif($dienthoai['sp_gia'] <30000000 ) echo "20_30";
                                        else echo "Tren30";
                            ?>
                        ">
