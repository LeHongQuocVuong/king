        ...
        <div class="container pt-2 filters">
            ...
            <div class="btn-group button-group flex-wrap flex-md-nowrap" role="group" aria-label="Basic example" data-filter-group="HDT">
                ...
                <button type="button" class="btn btn-outline-primary" data-type=".type1" title="Apple">
                    <img src="assets/img/logo/Apple.jpg" class="img-fluid d-none d-sm-block nsx" alt="">
                    <div class="d-sm-none d-block">Apple</div>
                </button>


                <button type="button" class="btn btn-outline-primary" data-type=".type2" title="Samsung">
                    <img src="assets/img/logo/Samsung.jpg" class="img-fluid d-none d-sm-block nsx" alt="">
                    <div class="d-sm-none d-block">Samsung</div>
                </button>


                <button type="button" class="btn btn-outline-primary" data-type=".type3" title="Huawei.jpg">
                    <img src="assets/img/logo/Huawei.jpg" class="img-fluid d-none d-sm-block nsx" alt="">
                    <div class="d-sm-none d-block">Huawei</div>
                </button>


                <button type="button" class="btn btn-outline-primary" data-type=".type4" title="Xiaomi">
                    <img src="assets/img/logo/Xiaomi.jpg" class="img-fluid d-none d-sm-block nsx" alt="">
                    ...
                    <div class="col a-product border pb-3 all btnGiaAll
                        <?php if($dienthoai['nsx_ma']==1) echo "type1 ";
                                elseif($dienthoai['nsx_ma']==2) echo "type2 ";
                                    elseif($dienthoai['nsx_ma']==4) echo "type3 ";
                                        elseif($dienthoai['nsx_ma']==3) echo "type4 ";
                                            elseif($dienthoai['nsx_ma']==8) echo "type5 ";
                                if($dienthoai['sp_gia'] <7000000 ) echo "Duoi1";
