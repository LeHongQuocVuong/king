            ...
            <div class="row">
                <div class="col col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (empty($sanpham['hinhdaidien'])) : ?>
                                                <img src="/king/assets/uploads/products/default-image_600.png" class="img-fluid hinhdaidien" />
                                            <?php else : ?>
                                                <img src="/king/assets/uploads/products/<?= $sanpham['hinhdaidien'] ?>" class="img-fluid hinhdaidien" />
                                            <?php endif; ?>
                                        </td>
                    ...
                    <?php else : ?>
                        <h2>Giỏ hàng rỗng!!!</h2>
                    <?php endif; ?>
                    <a href="/king/frontend" class="btn btn-warning btn-md"><i class="fa fa-arrow-left" aria-hidden="true"></i> Quay
                        về trang chủ</a>
                    <a href="/king/frontend/thanhtoan/thanhtoan.php" class="btn btn-primary btn-md"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Thanh toán</a>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            function removeSanPhamVaoGioHang(id) {
                ...
                $.ajax({
                    url: '/king/frontend/api/giohang-xoasanpham.php',
                    method: "POST",
                    dataType: 'json',
                    data: dulieugoi,
            ...
            function capnhatSanPhamTrongGioHang(id, soluong) {
                ...
                $.ajax({
                    url: '/king/frontend/api/giohang-capnhatsanpham.php',
                    method: "POST",
                    dataType: 'json',
                    data: dulieugoi,
                    success: function(data) {
