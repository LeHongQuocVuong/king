        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/../king/assets/frontend/img/slider-1.jpg" class="img-fluid homepage-slider-img" />
                    <div class="container">
                ...
                <div class="carousel-item">
                    <img src="/../king/assets/frontend/img/slider-2.jpg" class="img-fluid homepage-slider-img" />
                    <div class="container">
                ...
                <div class="carousel-item">
                    <img src="/../king/assets/frontend/img/slider-3.jpg" class="img-fluid homepage-slider-img" />
                    <div class="container">
        ...
        <div class="container marketing">
            ...
            <div class="row">
                <div class="col-lg-4 text-center">
                    <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="/../king/assets/frontend/img/icon-1.png" />
                    <h2>Đặt hàng</h2>
                    <p>Chọn sản phẩm bạn yêu thích, và Đặt hàng.</p>
                </div><!-- /.col-lg-4 -->
                <div class="col-lg-4 text-center">
                    <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="/../king/assets/frontend/img/icon-2.png" />
                    <h2>Tạo đơn hàng</h2>
                    <p>Theo dõi đơn hàng của bạn.</p>
                </div><!-- /.col-lg-4 -->
                <div class="col-lg-4 text-center">
                    <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="/../king/assets/frontend/img/icon-3.png" />
                    <h2>Giao hàng</h2>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <img src="/../king/assets/frontend/img/marketing-1.png" class="img-fluid" />
                </div>
            </div>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5 order-md-1">
                    <img src="/../king/assets/frontend/img/marketing-2.png" class="img-fluid" />
                </div>
            </div>
                            ...
                            <div class="card mb-4 shadow-sm">
                                <div class="card-header">
                                    ...
                                    <?php if (!empty($sanpham['hsp_tentaptin'])) : ?>
                                        <div class="container-img">
                                            <a href="./sanpham/detail.php?sp_ma=<?= $sanpham['sp_ma'] ?>">
                                                <img class="bd-placeholder-img card-img-top img-fluid" width="100%" height="350" src="/king/assets/uploads/products/<?= $sanpham['hsp_tentaptin'] ?>" />
                                            </a>
                                        </div>
                                    ...
                                    <?php else : ?>
                                        <div class="container-img">
                                            <a href="./sanpham/detail.php?sp_ma=<?= $sanpham['sp_ma'] ?>">
                                                <img class="bd-placeholder-img card-img-top img-fluid" width="100%" height="350" src="/king/assets/uploads/products/default-image_600.png" />
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </div>
