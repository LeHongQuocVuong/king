...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding: 0px;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent_1">
                    ...
                    <form class="mx-auto" style="flex-basis: 500px;" method="post" action="/king/timkiem.php">
                        <!-- <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button> -->
                        <div class="input-group">
                            <input type="text" name="timkiem" class="form-control" placeholder="Search" aria-label="Search"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item pl-2">
                            ...
                            ?>
                              ...
                              <a class="btn btn-outline-secondary" href="/king/backend/auth/logout.php">
                        ...
                        <li class="nav-item pl-2">
                            <a class="btn btn-outline-secondary" href="giohang.php" role="button">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-warning" style="padding: 0px;">
            <div class="container">
                <a class="navbar-brand nav-a" href="/king/index.php" title="Trang chủ">
                    <b>
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                    <a class="nav-a" href="/king/dienthoai.php" title="Điện thoại di động, smartphone">
                        <i class="fa fa-mobile fa-a" aria-hidden="true"></i>
                        <b>Điện thoại</b>
                    </a>
                    <a class="nav-a" href="/king/laptop.php" title="Máy tính xách tay">
                        <i class="fa fa-laptop" aria-hidden="true"></i>
                        <b>Laptop</b>
                    </a>
                    <a class="nav-a" href="/king/tablet.php" title="Máy tính bảng">
                        <i class="fa fa-tablet" aria-hidden="true"></i>
                        <b>Tablet</b>
                    </a>
                    <a class="nav-a" href="/king/phukien.php" title="Phụ kiện điện thoại, laptop, Tablet">
                        <i class="fa fa-headphones" aria-hidden="true"></i>
                        <b>Phụ kiện</b>
                    </a>
                    <a class="nav-a" href="/king/dongho.php" title="smartwatch">
                    ...
                    <a class="nav-a" href="gioithieu.php" title="">

                        <b>Giới thiệu</b>
                    </a>
                    <a class="nav-a" href="lienhe.php" title="">
